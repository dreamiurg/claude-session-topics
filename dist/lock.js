...
export function getLockPath(sessionId, dir) {
 ...
 */
export async function acquireLock(sessionId, dir, maxAge = 60000) {
 ...
 */
export async function isLocked(sessionId, dir) {
    const lockPath = getLockPath(sessionId, dir);
    try {
 ...
 */
export async function forceReleaseLock(sessionId, dir) {
    const lockPath = getLockPath(sessionId, dir);
    try {
