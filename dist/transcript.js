...
export function findTranscriptPath(sessionId, cwd) {
...
async function waitForTranscriptContent(path, maxWaitMs = 2000) {
...
export async function parseTranscript(path, contextLines = 50) {
    if (!existsSync(path)) {
        return null;
    }
